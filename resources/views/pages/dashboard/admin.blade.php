        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden group">
                    <div class="absolute -right-4 -top-4 w-20 h-20 bg-teal-50 rounded-full group-hover:scale-110 transition-transform"></div>
                    <div class="relative z-10">
                        <i class="bx bx-wallet text-3xl text-teal-600 mb-4 block"></i>
                        <p class="text-[11px] font-black uppercase tracking-widest text-slate-400 mb-1">Total Turnover</p>
                        <h3 class="text-2xl font-black text-slate-900">Rp {{ number_format($total_revenue, 0, ',', '.') }}</h3>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-[11px] font-black uppercase tracking-widest text-slate-400 mb-1">Rental Berjalan</p>
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-[11px] font-black uppercase tracking-widest text-slate-400 mb-1">Total Inventaris</p>
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-[11px] font-black uppercase tracking-widest text-slate-400 mb-1">Total Pelanggan</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
                ...
                <div class="lg:col-span-2 bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p class="text-[11px] font-black uppercase tracking-widest text-slate-400">Statistik 6 Bulan Terakhir</p>
                        </div>
                    </div>
                    <div class="h-64">
                ...
                <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
                    ...
                    <p class="text-[11px] font-black uppercase tracking-widest text-slate-400 mb-8">Distribusi Total Transaksi</p>
                    <div class="h-56">
                ...
                <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p class="text-[11px] font-black uppercase tracking-widest text-slate-400">Item paling sering disewa</p>
                        </div>
                    </div>
                    <div class="space-y-6">
                        @forelse($top_items as $item)
                        <div class="flex items-center gap-4 group">
                            <div class="w-12 h-12 rounded-xl bg-slate-50 flex items-center justify-center border border-slate-100 overflow-hidden">
                                <img src="{{ $item->multimediaItem->image }}" class="w-full h-full object-cover">
                            </div>
                            <div class="flex-1">
                                <h5 class="text-sm font-bold text-slate-800 group-hover:text-teal-600 transition-colors line-clamp-1">
                                    {{ $item->multimediaItem->name }}
                                </h5>
                                <p class="text-[11px] text-slate-400 font-medium">Disewa {{ $item->total_rented }} kali</p>
                            </div>
                            <div class="text-right">
                                <p class="text-sm font-black text-slate-700">Rp {{ number_format($item->multimediaItem->price_per_day, 0, ',', '.') }}</p>
                ...
                <div class="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p class="text-[11px] font-black uppercase tracking-widest text-slate-400">Aktifitas terbaru pelanggan</p>
                        </div>
                        <a href="{{ route('transaction.index') }}" class="text-[11px] font-black uppercase tracking-widest text-teal-600 hover:text-teal-700 transition-colors">Lihat Semua</a>
                    </div>
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <h5 class="text-sm font-bold text-slate-800 leading-none mb-1">{{ $trx->user->name }}</h5>
                                <p class="text-[11px] text-slate-400">ID: #RENT-{{ $trx->id }}</p>
                            </div>
                            <div class="text-right">
                                <p class="text-sm font-bold text-slate-700">Rp {{ number_format($trx->total_price, 0, ',', '.') }}</p>
                                @php
                                    $colors = [
                                ...
                                @endphp
                                <p class="text-[9px] font-black uppercase tracking-tighter {{ $colors[$trx->status] ?? 'text-slate-400' }}">
                                    {{ $trx->status }}
                                </p>
                            </div>
                        </div>
