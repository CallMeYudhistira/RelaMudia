        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="rounded-xl bg-white shadow-sm border border-gray-200">
                <div class="border-b border-gray-100 p-6">
                    <h2 class="text-xl font-semibold text-gray-800">Ubah Pengguna</h2>
                ...
                <form action="{{ route('users.update', $user->id) }}" method="POST" class="p-8">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <small style="color: #999; font-size: 0.8rem;">Kosongkan jika tidak mengubah
                                password</small>
                        </div>

                        <div class="space-y-2">
                            <label for="role" class="text-sm font-medium text-gray-700 block">Role / Jabatan</label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400">
