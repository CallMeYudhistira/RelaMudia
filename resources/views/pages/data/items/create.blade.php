<x-layout>
    <x-slot:title>Create | Items</x-slot:title>
    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl">
            ...
            <div class="rounded-xl bg-white shadow-sm border border-gray-200">
                ...
                <form action="{{ route('items.store') }}" method="POST" class="p-8" enctype="multipart/form-data">
                    @csrf
                    <div class="space-y-8">
                        <div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group my-2">
                                        ...
                                        <input type="number" name="price_per_day" id="price_per_day" required
                                            class="block w-full rounded-xl border border-gray-300 bg-white py-2.5 pl-10 pr-3 text-gray-900 transition-all focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 outline-none"
                                            placeholder="0" value="{{ old('price_per_day') }}" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group my-2">
                                        ...
                                        <input type="number" name="stock" id="stock" required
                                            class="block w-full rounded-xl border border-gray-300 bg-white py-2.5 pl-10 pr-3 text-gray-900 transition-all focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 outline-none"
                                            placeholder="0" value="{{ old('stock') }}" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
